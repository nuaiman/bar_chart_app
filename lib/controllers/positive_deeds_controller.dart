...
class PositiveDeedsController extends StateNotifier<List<Deed>> {
  PositiveDeedsController()
      : super([
          Deed(
            id: 7,
...
final positiveDeedsProvider =
    StateNotifierProvider<PositiveDeedsController, List<Deed>>((ref) {
  return PositiveDeedsController();
});
